      ...
      <div className="mx-auto w-full max-w-7xl">
        <div className="grid gap-8 md:grid-cols-2 md:gap-16 lg:gap-24">
          ...
          <div>
            ...
            >
              <h2 className="mb-3 font-sans text-3xl font-light leading-[1.1] tracking-tight text-foreground md:mb-4 md:text-6xl lg:text-7xl">
                ...
                future of
                <br />
                <span className="text-foreground/40">logistics</span>
              </h2>
            </div>
            ...
            >
              <p className="max-w-md text-sm leading-relaxed text-foreground/90 md:text-lg">
                We're a collective of aerospace engineers, AI researchers, and logistics experts obsessed with redefining
                aerial transport.
              </p>
              <p className="max-w-md text-sm leading-relaxed text-foreground/90 md:text-lg">
                Every mission is an opportunity to push the boundaries of speed, efficiency, and autonomous reliability.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-center space-y-6 md:space-y-12">
            {[
              { value: "50k+", label: "Deliveries", sublabel: "Completed successfully", direction: "right" },
              { value: "99.9%", label: "Reliability", sublabel: "Mission success rate", direction: "left" },
              { value: "24/7", label: "Operations", sublabel: "All-weather capability", direction: "right" },
            ].map((stat, i) => {
